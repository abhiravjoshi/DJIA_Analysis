...
xlabel('Date')
ylabel('DJIA (log)')
title('DJIA Plot on SemilogY Scale')
...
title('Predicted Values (xhat1 and xhat2) adn Actual DJIA Data Comparison')
xlabel('date')
...
title('Plot of xhat1 error and xhat2')
xlabel('date')
...
figure
plot(p_arr,E,'*-');
title('Sum of Squared Prediction Error vs Order')
xlabel('order')
ylabel('MSE')
